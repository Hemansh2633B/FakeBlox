export class HUD {
  ...
  constructor(onCopySeed?: (seed: string) => void) {
    ...
    this.element.innerHTML = `<div id="hud-timer">00:00.000</div><div id="hud-deaths">💀 0</div><div id="hud-stars">⭐ 0</div><div id="hud-seed-wrap"><span id="hud-seed">Seed: unknown</span><button id="hud-copy-seed">Copy Seed</button></div>`;
  ...
  private applyStyles(): void { Object.assign(this.element.style, { position: 'absolute', top: '0', left: '0', width: '100%', display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '20px', color: 'white', fontSize: '24px', pointerEvents: 'none', textShadow: '2px 2px 4px rgba(0,0,0,0.5)' }); }
